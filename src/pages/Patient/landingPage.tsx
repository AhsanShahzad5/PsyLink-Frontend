...
//     description:
//       "Software Engineer with focus on api integrations",
//     image: "/src/assets/patient/landingPage/ahsan.png",
//     social: [
...
//     description:
// "Project Manager with expertize in UI/UX ",
...
//     description:
//     " Senior Software Engineer specializing in system design" ,
//     image: "/src/assets/patient/landingPage/man.png",
//     social: [
//       { icon: "/src/assets/patient/landingPage/Facebook.png", alt: "Facebook" },
//       { icon: "/src/assets/patient/landingPage/Twitter.png", alt: "Twitter" },
...
//               Copyright © 2025 PsyLink | All Rights Reserved
//             </p>
//           </div>
...
const teamMembers = [
  {
    name: "Ahsan Shahzad",
    designation: "Software Engineer",
    description: "Software Engineer with focus on api integrations",
    image: "/src/assets/patient/landingPage/ahsan.png",
    social: [
      { icon: "/src/assets/patient/landingPage/Facebook.png", alt: "Facebook" },
      { icon: "/src/assets/patient/landingPage/Twitter.png", alt: "Twitter" },
  ...
  },
  {
    name: "Abbad Malik",
    designation: "Project Manager",
    description: "Project Manager with expertize in UI/UX",
    image: "/src/assets/patient/landingPage/abbad.jpg",
    social: [
      { icon: "/src/assets/patient/landingPage/Facebook.png", alt: "Facebook" },
      { icon: "/src/assets/patient/landingPage/Twitter.png", alt: "Twitter" },
      { icon: "/src/assets/patient/landingPage/LinkedIn.png", alt: "LinkedIn" },
  ...
  },
  {
    name: "Fahad Tariq",
    designation: "Senior Software Engineer",
    description: "Senior Software Engineer specializing in system design",
    image: "/src/assets/patient/landingPage/fahad.jpg",
    social: [
      { icon: "/src/assets/patient/landingPage/Facebook.png", alt: "Facebook" },
      { icon: "/src/assets/patient/landingPage/Twitter.png", alt: "Twitter" },
      { icon: "/src/assets/patient/landingPage/LinkedIn.png", alt: "LinkedIn" },
...
const LandingPage = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-10 w-full bg-transparent" style={{ height: "100vh", overflowY: "auto" }}>
      
      {/* Header Section */}
      <div className="w-full h-auto p-2 sm:p-4" style={{ background: "linear-gradient(360deg, #064034 60%, #047D72 100%)" }}>
        {/* Navbar */}
        <nav className="flex justify-between items-center bg-[#549d95] w-full h-[50px] sm:h-[60px] rounded-lg px-3 sm:px-8">
          <div className="flex items-center space-x-2 sm:space-x-3">
            <img src="/src/assets/patient/homePage/Logo.png" alt="PsyLink Logo" className="w-6 h-6 sm:w-8 sm:h-8" />
            <span className="text-base sm:text-lg font-bold text-white">PsyLink</span>
          </div>
          ...
          <div className="hidden sm:flex space-x-4 lg:space-x-12 text-white text-sm lg:text-base">
            <a href="#features" className="hover:underline">Features</a>
            <a href="#about" className="hover:underline">About</a>
            <a href="#resources" className="hover:underline">Resources</a>
            <a href="#contact" className="hover:underline">Contact</a>
          ...
          <div className="hidden sm:flex items-center gap-0">
            <button className="font-bold text-lg sm:text-xl text-black hover:underline" onClick={() => navigate('/login')}>
              Login
            </button>
            <span className="mx-3 sm:mx-4 text-black text-lg sm:text-xl">•</span>
            <button className="font-normal text-sm sm:text-base text-white bg-[#131114] py-1.5 sm:py-2 px-3 sm:px-4 rounded-full hover:bg-[#0c0c0c]" onClick={() => navigate('/sign-up')}>
              Sign Up
            </button>
          </div>
        </nav>
        ...
        {/* Hero Section */}
        <div className="flex flex-col lg:flex-row mt-6 lg:mt-12 items-center lg:items-start">
          <div className="flex flex-col w-full lg:w-[350px] px-3 sm:px-6 lg:px-8 text-center lg:text-left">
            ...
            <p className="mt-3 text-sm sm:text-base text-white leading-relaxed">
              Connecting you to compassionate care, anytime, anywhere – Welcome to Psylink, your gateway to mental well-being.
            </p>
            <div className="flex justify-center lg:justify-start mb-6 lg:mb-8">
              <button className="mt-4 py-2 px-4 bg-[#000] text-white text-sm font-bold rounded-xl hover:bg-[#345956] flex items-center" onClick={() => navigate('/login')}>
                GET STARTED!
                <img src="/src/assets/patient/landingPage/RightArrow.png" alt="Right Arrow" className="w-5 h-5 sm:w-6 sm:h-6 ml-2" />
              </button>
            </div>
          </div>

          <div className="flex w-full lg:w-auto justify-center lg:justify-end mt-4 lg:mt-0 space-x-2">
            <img src="/src/assets/patient/landingPage/landing1.png" alt="Group Session" className="w-[90px] sm:w-[140px] lg:w-[280px] h-[100px] sm:h-[200px] lg:h-[320px] object-cover rounded-lg" />
            <img src="/src/assets/patient/landingPage/landing2.png" alt="Personal Therapy" className="w-[90px] sm:w-[140px] lg:w-[280px] h-[100px] sm:h-[200px] lg:h-[320px] object-cover rounded-lg" />
            <img src="/src/assets/patient/landingPage/landing3.png" alt="Writing Therapy" className="w-[90px] sm:w-[140px] lg:w-[280px] h-[100px] sm:h-[200px] lg:h-[320px] object-cover rounded-lg" />
          </div>
        </div>
      </div>
      ...
      {/* Features Section */}
      <section id="features">
        <div className="flex flex-col items-center justify-center w-full sm:w-[400px] h-[120px] bg-transparent rounded-[50px] mt-8 mx-auto">
          <button className="px-6 sm:px-8 py-2 text-white font-normal text-lg sm:text-xl rounded-full" style={{ background: "linear-gradient(270deg, #064034 60%, #047D72 100%)" }}>
            Features
          </button>
          <p className="mt-4 font-normal text-lg sm:text-xl text-black text-center">
            Why Are We Better than Others?
          </p>
        </div>
      </section>

      <div className="w-full max-w-[1200px] mx-auto p-4 sm:p-8 space-y-6">
        {/* AI Chat Support */}
        <div className="bg-white rounded-xl p-6 sm:p-8 space-y-3">
          <h2 className="font-bold text-xl sm:text-2xl text-center mb-3">AI Chat Support</h2>
          <div className="flex justify-center items-center">
            <img src="/src/assets/patient/landingPage/ChatAI.png" alt="AI Chat" className="w-[40px] h-[40px] mr-3" />
          </div>
          <p className="font-normal text-base sm:text-lg text-center text-black">
            Introducing <strong>Allen</strong>, Psylink's AI chatbot designed to help you vent your frustrations in a safe, supportive space. Allen listens with empathy, offering calming and compassionate responses to make sure you feel heard and never alone.
          </p>
        </div>

        {/* Online Doctor & E-Prescription */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          <div className="bg-white rounded-2xl p-6 sm:p-8 space-y-3">
            <div className="flex items-center mb-3">
              <img src="/src/assets/patient/landingPage/Phone.png" alt="Phone" className="w-[40px] h-[40px] mr-3" />
              <h2 className="font-bold text-lg sm:text-xl">Online Doctor Consultation</h2>
            </div>
            <p className="font-normal text-base sm:text-lg  text-black">
              Anonymous Doctor Consultation lets you connect with mental health professionals securely, ensuring privacy and support without revealing your identity.
            </p>
          </div>

          <div className="bg-white rounded-2xl p-6 sm:p-8 space-y-3">
            <div className="flex items-center mb-3">
              <img src="/src/assets/patient/landingPage/E-prescription.png" alt="E-Prescription" className="w-[40px] h-[40px] mr-3" />
              <h2 className="font-bold text-lg sm:text-xl">E-Prescription</h2>
            </div>
            <p className="font-normal text-base sm:text-lg  text-black">
              You can receive prescriptions from licensed doctors after a consultation, all from the comfort of your home. Convenient, fast, and fully digital.
            </p>
          </div>
        </div>
        ...
        {/* Community Section */}
        <div className="bg-white rounded-2xl p-6 sm:p-8 space-y-3">
          <h2 className="font-bold text-xl sm:text-2xl text-center mb-3">Psylink Community - Psync</h2>
          <div className="flex justify-center items-center">
            <img src="/src/assets/patient/landingPage/Community.png" alt="Community" className="w-[40px] h-[40px] mr-3" />
          </div>
          <p className="font-normal text-base sm:text-lg text-center  text-black">
            Our Community Support feature is a safe space where individuals can openly share their mental health journeys and experiences. It's a place to find encouragement, connect with others, and offer support.
          </p>
        </div>
      </div>
      ...
      {/* About Section */}
      <section id="about">
        <div className="flex flex-col items-center justify-center w-full sm:w-[400px] h-[120px] bg-transparent rounded-[50px] mx-auto">
          <button className="px-6 sm:px-8 py-2 text-white font-normal text-lg sm:text-xl rounded-full" style={{ background: "linear-gradient(270deg, #064034 60%, #047D72 100%)" }}>
            About
          </button>
        </div>
      ...
      <div className="flex flex-col lg:flex-row items-start bg-white rounded-xl p-6 sm:p-8 shadow-md max-w-[1150px] mx-auto">
        <div className="w-full lg:w-1/2 space-y-4">
          <div className="flex items-center space-x-3 mb-4">
            <img src="/src/assets/patient/homePage/Logo.png" alt="PsyLink Logo" className="w-[40px] h-[40px]" />
            <h1 className="font-bold text-xl sm:text-2xl">PsyLink</h1>
          </div>
          <div>
            <p className="font-normal text-base sm:text-lg text-left mb-3  text-black">
              We are committed to making mental healthcare accessible, supportive, and stigma-free for everyone.
            </p>
            <p className="font-normal text-base sm:text-lg text-left mb-3  text-black">
              Our platform offers a range of tools, including Anonymous Online Doctor Consultations, to provide professional guidance without fear of judgment.
            </p>
            <p className="font-normal text-base sm:text-lg text-left  text-black">
              Whether you need a safe place to vent, compassionate AI support, or connection within a caring community, Psylink is here to empower you on your journey to better mental health.
            </p>
          </div>
        </div>

        <div className="w-full lg:w-1/2 flex justify-center items-center mt-6 lg:mt-0">
          <div className="w-full h-[250px] lg:h-[400px] border border-dashed border-gray-400 rounded-lg flex items-center justify-center overflow-hidden relative">
            <div className="w-[95%] h-[95%] translate-x-[5%]">
              <Spline scene="https://prod.spline.design/Vk2WhhCLdgXrP0ub/scene.splinecode" className="w-full h-full" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center w-full sm:w-[400px] h-[120px] bg-transparent rounded-[50px] mt-8 mx-auto">
        ...
        <p className="mt-4 font-normal text-base sm:text-lg text-black text-center">
          Welcome to our prestigious members who made PsyLink a real world application.
        </p>
      </div>
      ...
      <div className="bg-transparent py-6">
        <div className="container mx-auto flex flex-wrap justify-center gap-6">
          {teamMembers.map((member, index) => (
            <div key={index} className="bg-white shadow-md rounded-lg p-5 w-full sm:w-[280px] flex flex-col items-center text-center">
              <img src={member.image} alt={member.name} className="w-20 h-20 rounded-full object-cover mb-3" />
              <h3 className="font-bold text-base text-[#064034]">{member.name}</h3>
              <p className="font-medium text-sm text-[#047D72] mb-3">{member.designation}</p>
              <p className="text-sm text-gray-600 mb-4">{member.description}</p>
              <div className="flex space-x-3">
                {member.social.map((social, i) => (
                  <a key={i} href="#" className="w-5 h-5">
      ...
      <section id="contact">
        <div className="flex flex-col items-center justify-center bg-transparent py-8">
          <h2 className="font-bold text-xl sm:text-2xl text-center mb-6">Subscribe to our newsletter</h2>
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3 w-full px-4 sm:px-0">
            <input type="email" placeholder="Enter your email" className="w-full sm:w-[380px] h-[45px] rounded-full px-4 text-base border border-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-500" />
            <button className="w-full sm:w-auto h-[45px] px-6 bg-[#047D72] text-white rounded-full font-bold text-base">
              Subscribe
            </button>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-r from-[#064034] to-[#047D72] text-white py-8 px-6 sm:px-24">
        <div className="container mx-auto flex flex-col lg:flex-row justify-between items-start space-y-8 lg:space-y-0">
          <div className="flex flex-col space-y-3">
            <div className="flex items-center space-x-2">
              <img src="/src/assets/patient/homePage/Logo.png" alt="PsyLink Logo" className="w-8 h-8" />
              <h1 className="text-base font-semibold">PsyLink</h1>
            </div>
            <p className="text-sm text-gray-300">Copyright © 2025 PsyLink | All Rights Reserved</p>
          </div>

          <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
            <div className="flex flex-col space-y-2">
              <h3 className="font-bold text-base">Product</h3>
              <a href="#" className="text-gray-300 text-sm hover:text-white">Features</a>
              <a href="#" className="text-gray-300 text-sm hover:text-white">Pricing</a>
              <a href="#" className="text-gray-300 text-sm hover:text-white">Case studies</a>
              <a href="#" className="text-gray-300 text-sm hover:text-white">Reviews</a>
              <a href="#" className="text-gray-300 text-sm hover:text-white">Updates</a>
            </div>

            <div className="flex flex-col space-y-2">
              <h3 className="font-bold text-base">Company</h3>
              <a href="#" className="text-gray-300 text-sm hover:text-white">About</a>
              <a href="#" className="text-gray-300 text-sm hover:text-white">Contact us</a>
              <a href="#" className="text-gray-300 text-sm hover:text-white">Careers</a>
              <a href="#" className="text-gray-300 text-sm hover:text-white">Culture</a>
              <a href="#" className="text-gray-300 text-sm hover:text-white">Blog</a>
            </div>

            <div className="flex flex-col space-y-2">
              <h3 className="font-bold text-base">Support</h3>
              <a href="#" className="text-gray-300 text-sm hover:text-white">Getting started</a>
              <a href="#" className="text-gray-300 text-sm hover:text-white">Help center</a>
              <a href="#" className="text-gray-300 text-sm hover:text-white">Server status</a>
              <a href="#" className="text-gray-300 text-sm hover:text-white">Report a bug</a>
              <a href="#" className="text-gray-300 text-sm hover:text-white">Chat support</a>
            </div>
