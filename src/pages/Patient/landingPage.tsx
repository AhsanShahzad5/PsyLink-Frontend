...
const LandingPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <nav className="flex justify-between items-center bg-[#3d7a6e] w-full h-[60px] rounded-lg border-b border-gray-200 px-4 sm:px-8">
          ...
          <div className="flex items-center gap-0">
            {/* Login Button */}
            <button className="font-syne font-bold text-[25.2px] leading-[30.24px] text-black hover:underline "
        ...
        <div className="flex flex-col lg:flex-row mt-8 lg:mt-16 items-center lg:items-start">
          ...
          <div className="flex flex-col w-full lg:w-[400px] px-4 sm:px-6 lg:px-12 text-center lg:text-left">
            ...
            <div className="flex justify-center lg:justify-start">
              <button className="mt-6 py-2 px-4 sm:px-6 bg-[#000] text-[#fff] text-sm sm:text-md font-bold rounded-xl hover:bg-green-700 flex items-center"
                onClick={ () => navigate('/patient/Home')}
              >
                GET STARTED!
                <img
      ...
      {/* Features Section */}
      <div className="flex flex-col items-center justify-center w-[485px] h-[181px] bg-transparent rounded-[50px] mt-16 mx-auto">
        {/* Features Button */}
        <button className="px-10 py-2 text-white font-outfit font-normal text-2xl leading-[41.58px] rounded-full flex items-center justify-center" style={{
        ...
        <p className="mt-6 font-outfit font-normal text-[33px] leading-[41.58px] text-black text-center">
          Why Are We Better than Others?
        </p>
      </div>
      ...
      <div className="w-full max-w-[1648px] mx-auto p-8 space-y-10 px-24">
      {/* AI Chat Support Section */}
      <div className="bg-[#fff] rounded-xl p-8 shadow-md px-12">
        <h2 className="font-outfit font-bold text-3xl leading-[47.88px] text-center mb-4">
          AI Chat Support
        </h2>
        ...
        <p className="font-outfit font-normal text-2xl leading-[41.58px] text-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 ">
        ...
        <div className="bg-[#fff] rounded-2xl p-8 shadow-md">
          <div className="flex items-center mb-4">
            <img
              ...
              className="w-[50px] h-[50px] mr-4"
            />
            <h2 className="font-outfit font-bold text-3xl leading-[47.88px]">
              Online Doctor Consultation
            </h2>
          </div>
          <p className="font-outfit font-normal text-2xl leading-[41.58px]">
     ...
     {/* About Section */}
     <div className="flex flex-col items-center justify-center w-[485px] h-[181px] bg-transparent rounded-[50px] mx-auto">
        {/* About Button */}
        <button className="px-10 py-2 text-white font-outfit font-normal text-2xl leading-[41.58px] rounded-full flex items-center justify-center" style={{
          background: "linear-gradient(270deg, #064034 60%, #047D72 100%)",
        }}>
      ...
      <div className="flex flex-col lg:flex-row items-start bg-[#fff] rounded-xl p-8 shadow-md max-w-[1648px] mx-10">
      {/* Left Div */}
      ...
      <div className="w-full lg:w-1/2 flex justify-center items-center mt-10">
            <div className="w-full h-[300px] lg:h-[500px] border border-dashed border-gray-400 rounded-lg flex items-center justify-center overflow-hidden relative mt-2">
      ...
      <div className="flex flex-col items-center justify-center w-[485px] h-[181px] bg-transparent rounded-[50px] mt-16 mx-auto">
        ...
        {/* Why Are We Better than Others? */}
        <p className="mt-6 font-outfit font-normal text-2xl leading-[41.58px] text-black text-center">
        Welcome to out prestegious Members who made psylink a real world application.
        </p>
      </div>
      ...
      <div className="container mx-auto flex flex-wrap justify-center gap-8">
        {teamMembers.map((member, index) => (
          <div
            key={index}
            className="bg-white shadow-md rounded-lg p-6 w-[300px] flex flex-col items-center text-center"
          >
            {/* Image */}
            <img
              src={member.image}
    ...
    <div className="flex flex-col items-center justify-center bg-transparent py-16">
      ...
      <div className="flex items-center space-x-4">
        ...
        <input
          ...
          className="w-[484.97px] h-[55.39px] rounded-full px-6 text-[22.34px] font-dm-sans font-normal leading-[25.13px] placeholder-gray-500 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-500"
        />

        {/* Subscribe Button */}
        <button className="h-[56.26px] px-8 bg-[#047D72] text-white rounded-full font-dm-sans font-bold text-[22.34px] leading-[25.13px]">
          Subscribe
        </button>
      </div>
    </div>
