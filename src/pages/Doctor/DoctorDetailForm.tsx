...
//   const fileRef = useRef(null);
  ...
  const handleSubmit = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    e.preventDefault();
    console.log("Form Submission:", { fullName, country, age, city, gender, phoneNo, disability });
  }
  ...
  return (
    <div>
      ...
      <input 
        ...
        className="mt-1 p-3 block w-full border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 rounded-xl"
      />
    </div>
  );
}
