        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="border-t border-b border-teal-500 py-8">
            <p className="text-lg text-gray-900 leading-relaxed text-left">
              Your Request has been sent. We shall let you know via email about
              your verification. Thank you for waiting.
            </p>
          </div>
          ...
          <div className="flex justify-center">
            <a
              href="/doctor/home"
              className="inline-block w-full max-w-xs py-3 px-4 text-lg bg-teal-500 hover:bg-teal-600 text-white rounded-md transition-colors text-center"
            >
              Go Home
            </a>
          </div>
